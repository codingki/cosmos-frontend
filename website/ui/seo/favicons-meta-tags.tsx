...
export function FaviconsMetaTags() {
  return (
    <>
      ...
      <meta content="#C8F2CE" name="theme-color" />
      <meta content={metadataJson.name} name="application-name" />
      ...
      <meta content={metadataJson.name} name="apple-mobile-web-app-title" />
      <link
      ...
      <link
        ...
        rel="apple-touch-startup-image"
      />
      <meta content="#C8F2CE" name="msapplication-TileColor" />
